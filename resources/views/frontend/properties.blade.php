    ...
    <div class="bg-cyan-900 mx-24 p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 md:col-span-4">
                <div class="flex rounded-md border-2 border-blue-500 overflow-hidden max-w-md mt-4 mx-auto font-[sans-serif]">
                    <input
                        type="email"
        ...
        <div class="grid grid-cols-2 gap-4 mb-4 text-xs">
            <div class="mt-4">
                ...
                <div class="flex space-x-2">
                    <input type="number" placeholder="- Min-" class=" bg-cyan-900 border border-indigo-100 text-white p-2  w-16">
                    <input type="number" placeholder="- Max -" class="bg-cyan-900 border border-indigo-100 text-white p-2  w-16">
                </div>
            </div>
            <div class="mt-4">
                <div class="flex space-x-2 justify-end mt-4">
                    <button type="button" class="bg-cyan-900 border border-indigo-100 text-white p-2 text-center"> SEARCH </button>
                    <button type="button" class="bg-cyan-900 border border-indigo-100 text-white p-2  text-center">-CLEAR -</button>
                    <button type="button" class="border border-white text-white px-4 py-2 rounded">VIEW ALL FILTER</button>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-center">
            <div class="w-full">
                ...
                <select id="bedrooms" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
            ...
            <div class="w-full">
                ...
                <select id="property-features" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
            ...
            <div class="w-full">
                ...
                <select id="furnishing" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
            ...
            <div class="w-full">
                ...
                <select id="parking" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
            ...
            <div class="w-full">
                ...
                <select id="sort-by" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
            ...
            <div class="w-full">
                ...
                <select id="company-or-agent" class="w-full p-1 text-xs text-white bg-cyan-900 border-b border-blue-400 focus:outline-none focus:border-blue-300 placeholder-blue-300">
                    <option>Any</option>
                </select>
            </div>
    ...
    <div class="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-1">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded shadow-md overflow-hidden">
                    <img src="path/to/image.jpg" alt="News Image" class="w-full h-40 object-cover">
                    <div class="p-4">
                        <h3 class="text-sm font-medium">The Commercial Avenue and Al Saif Gallery Sign Long-Term Lease Agreement</h3>
                    </div>
                </div>
        ...
        <div class="col-span-2 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded shadow-md">
                <img src="https://www.qatarliving.com/_next/image?url=https%3A%2F%2Fwww.qatarliving.com%2Fq%2Fs3%2Ffiles%2Fstyles%2Fvehicle_listing_v3%2Fs3%2Fvehicles%2F2024%2F07%2F20%2F9999102%2FDSC09776_1.jpg&w=384&q=75" alt="Property Image" class="w-full h-40 object-cover mb-2">
              <div class="p-2">
                <h4 class="text-xs font-bold text-gray-500 uppercase">Apartment</h4>
                <p class="text-lg font-semibold">No Commission, Bills Included 1 BR Near MUSHIEREB</p>
                <p class="text-lg text-blue-600 font-bold">4,300 QAR/Month</p>
                <p class="text-xs text-gray-400 mt-1">FEREEJ ABDEL AZIZ</p>
            ...
            <!-- Single Ad Section -->
            <div class="bg-white rounded shadow-md col-span-full flex flex-col md:flex-row gap-4">
                <img src="https://www.qatarliving.com/q/s3/files/styles/listing_ratio_3_2/s3/vehicles/2024/08/04/7476736/%D9%A2%D9%A0%D9%A2%D9%A4%D9%A0%D9%A8%D9%A0%D9%A4_%D9%A1%D9%A2%D9%A5%D9%A5%D9%A1%D9%A0.jpg" alt="Ad Image" class="w-full md:w-1/3 h-40 object-cover mb-2 md:mb-0">
                <div class="flex-1 mt-1">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="col-span-1">
                            <h4 class="text-xs font-bold text-blue-500 uppercase mb-1">For Rent • Residential • Villa Apartment</h4>
                        </div>
                        ...
                        <div class="col-span-1">
                            <div>
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <p class="text-lg font-normal flex items-center">
                                        <i class="ti ti-bed text-5xl mr-2"></i> Studio
                                    </p>
