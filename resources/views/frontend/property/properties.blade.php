<x-guest-layout>
    ...
    <div class="grid grid-cols-1 mx-24 mt-4 mb-4 md:grid-cols-2 gap-4 font-mono">
        ...
        <div class="col-span-1 justify-cemter items-center">
            <div class="flex gap-3">
                <div class="text-xs font-bold text-gray-400  mb-1 flex items-center mr-4">
                    <i class="ti ti-heart-handshake text-5xl"></i>
                </div>

                <h2 class=" text-xl pr-60 text-gray-500">Want to advertise on Qatar Living?
                    Take a look at our Advertise page</h2>
            </div>
            <h2 class="text-gray-500 text-xl mt-8 justify-center items-center">Help us improve Qatar Living. Send us
                feedback or Contact Us</h2>
            <div class="flex gap-1 mt-4 justify-center items-center">
                <img src="https://www.qatarliving.com/_next/image?url=%2Fimages%2Fbadge-app-store.png&w=128&q=75"
                    alt="">
                <img src="https://www.qatarliving.com/_next/image?url=%2Fimages%2Fbadge-google-playstore.png&w=128&q=75"
                    alt="">
            </div>
            <div class="bg-purple-300 p-6 mt-4 mb-4">
                <h2 class="text-center text-white mb-4">Subscribe to our newsletter to get the latest updates</h2>
                <div class="flex justify-center items-center gap-4">
                    <input type="email" placeholder="Email"
                        class="p-3 w-96  bg-purple-400 text-white placeholder-white outline-none  " />
                    <button
