...
<div class="sm:pl-20 sm:pr-30 ">
    ...
    <div class="mt-6 mx-5 mb-40">
        <h1 class="font-bold text-xl text-purple-950">Add the complete detail of your Medical</h1>
        @include('error')

        <form class="mt-8" action="{{ route('user.medicalList.store',$subCategory) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="block md:grid grid-cols-4 pr-16">
                <div class="col-span-2 mr-6">

                    <x-frontend.forms.input-type-field label="Medical Name" id="medical_name"
                    ...
                    <x-frontend.forms.input-type-field label="Medical Address" id="medical_address"
                ...
                <div class="col-span-2">
                    ...
                    <x-frontend.forms.input-type-field label="Whats App" id="whats_app_no"
                        ...
                        label="Medical Image Of All Side"
                        id="files"
                        name="files[]"
                        type="file"
