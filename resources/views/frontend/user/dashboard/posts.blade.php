                            ...
                            <div class="-m-1.5 overflow-x-auto">
                                <div class="p-1.5 min-w-full inline-block align-middle">
                                    <div class="overflow-hidden">
                                        <x-frontend.forms.table-component :headers="['Reference No', 'Title', 'SubCategory', 'Rate', 'Bed Room','Bathroom', 'Action']" :data="$subCategory->propertyLists">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                    <a type="button" href="{{ route('user.user.propertyLists.edit', [$subCategory->slug, $propertyList->id]) }}"
