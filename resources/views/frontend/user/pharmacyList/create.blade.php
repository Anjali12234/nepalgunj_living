...
<div class="sm:pl-20 sm:pr-30 ">
    ...
    <div class="mt-6 mx-5 mb-40">
        <h1 class="font-bold text-xl text-purple-950">Add the complete detail of your Pharmacy</h1>
        @include('error')

        <form class="mt-8" action="{{ route('user.pharmacyList.store',$subCategory) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="block md:grid grid-cols-4 pr-16">
                <div class="col-span-2 mr-6">

                    <x-frontend.forms.input-type-field label="Pharmacy Name" id="pharmacy_name"
                    ...
                    <x-frontend.forms.input-type-field label="Contact No" id="contact_number"
                        ...
                        <x-frontend.forms.input-type-field label="Opening Time" type="text" id="opening_hours" name="opening_hours"
                        class="text-sm font-semibold" />

                    <x-frontend.forms.input-type-field label="Pharmacy Address" id="pharmacy_address"
                        name="pharmacy_address" type="text" class="text-sm font-semibold"
                        {{-- placeholder="Per Month" --}} />
                ...
                <div class="col-span-2">
                    ...
                    <x-frontend.forms.input-type-field label="Whats App" id="whats_app_no"
                        ...
                        label="Pharmacy Image Of All Side"
                        id="files"
                        name="files[]"
                        type="file"
