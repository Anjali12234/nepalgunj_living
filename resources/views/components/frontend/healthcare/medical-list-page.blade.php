<div class="px-2 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight"> Medical Store </h2>
        <p class="mt-1 text-gray-600">Meet our top medical Store who are leading the way in medical excellence and
            patient
            care.</p>
    </div>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a class="group border border-fuchsia-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10"
            href="{{ route('healthcare.medicalDetailPage') }}">
