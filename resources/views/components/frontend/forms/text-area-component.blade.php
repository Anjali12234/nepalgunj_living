...
<div class="block lg:flex items-center mb-3">
   ...
   <textarea name="{{ $name }}" id="{{ $id }}" placeholder="{{ $placeholder }}" cols="30" rows="10" class="{{ $class }} px-2 pt-1 pb-2 w-80 md:w-96 border-b-2 focus:border-[#333] outline-none  bg-white">{{ $value }}</textarea>
